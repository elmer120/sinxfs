...
<div id="{{ $modal_id }}" class="uk-modal-container" uk-modal='{"bg-close":false}'>
    <div class="uk-modal-dialog" uk-overflow-auto>
		...
		<form id="{{ $form_id }}" class="uk-grid-small" enctype="multipart/form-data" uk-grid>
				...
				<legend class="uk-legend">Dati anagrafici</legend>
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" id="{{ $select_province_nascita_id }}">
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" id="{{ $select_comuni_nascita_id }}" name="fk_comuni_nascita" value="">
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" id="{{ $select_regioni_id }}" >
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" id="{{ $select_province_id }}" >
								<option value="" selected>Scegli la provincia</option>
							</select>
						</div>
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" id="{{ $select_comuni_id }}" name="fk_comuni" value="" >
								<option value="" selected>Scegli il comune</option>
							</select>
						</div>
				...
				<legend class="uk-legend">Varie</legend>
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" name="fk_responsabile" id="{{ $select_responsabile_id }}">
				...
				<input id="socio_checkbox" class="uk-checkbox" type="checkbox" name="socio"> </legend> 
						...
						<div class="uk-width-1-6@m">
							...
							<select class="uk-select uk-form-small" id="{{ $select_tipo_id }}" name="fk_soci_tipologie" value="" disabled>
				...
				<input id="carica_direttivo_checkbox" class="uk-checkbox" name="carica_direttivo" type="checkbox" disabled> </legend>
						...
						<div class="uk-width-1-6@m">  
							...
							<select class="uk-select uk-form-small" id="{{ $select_carica_id }}" name="fk_cariche_direttivo" value="" disabled>
