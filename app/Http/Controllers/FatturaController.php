...
class FatturaController extends Controller
{
    ...
    {
        return view('contabilita.fattura')
        ->with('tab_title',"Fattura")
        ->with('page_title' , "Fattura");
    }
    ...
    {
         $lista = DB::table('fatture')
        ->join('persone', 'fatture.fk_persone', '=', 'persone.id')
        ->join('pagamenti','pagamenti.fk_fatture','=','fatture.id')
